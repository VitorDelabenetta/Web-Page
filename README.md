...
Página Web conectada através de links, produzida para aplicar os aprendizados recentes em desenvolvimento web, principalmente dos estudos em Javascript.

<br>
O projeto fora produzido seguindo e modificando tutoriais diversos da Internet, principalmente o que compele ao javascript. Fazer este projeto permitiu-me estudar sobre a manipulação dos elementos do DOM (Document Object Model) e aplicar alguns aprendizados recentes em CSS, principalmente na tangente de facilitação das folhas de estilos por seletores mais eficientes.
...
```bash
git clone https://github.com/VitorDelabenetta/Web-Page.git
```
...
<img src="./assets/imagens/preview.png" alt="imagem-da-página-principal" style="width: 100%"/>

<i>Imagem de preview, mostrando a página inicial</i>
